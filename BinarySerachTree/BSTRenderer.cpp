...
bool BSTRenderer::enqueue(BinarySearchTreeNode* node, int lv, int rPos)
{
    if (!isFull)
    {
...
int BSTRenderer::countLevel(BinarySearchTree& bst)
{
    int level = 0;
    int stopCount = 0;
...
void BSTRenderer::render(BinarySearchTree& bst)
{
